...
const TENANT_MENU_ITEMS = [
  ...
  { key: '/hospitals', icon: <BankOutlined />, label: 'Hospitals', permission: 'hospitals.view', section: 'Clinical' },
  { key: '/ambulance-requests', icon: <AlertOutlined />, label: 'Ambulance Requests', permission: 'ambulance.view', section: 'Clinical' },
  { key: '/articles', icon: <ReadOutlined />, label: 'Articles', permission: 'articles.view', section: 'Content' },
  { key: '/women-health', icon: <WomanOutlined />, label: "Women's Health", permission: 'women_health.view', section: 'Content' },
...
const SUPER_ADMIN_MENU_ITEMS = [
  ...
  { key: '/platform/policies', icon: <FileProtectOutlined />, label: 'Policies', superAdminOnly: false },
